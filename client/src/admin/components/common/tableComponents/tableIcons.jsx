...
export const IconSort = () => (
  <svg width="9" height="12" viewBox="0 0 10 14" fill="none">
    <path d="M5 0L9 5H1L5 0Z" fill="currentColor" className="dt-sort-up" />
    <path d="M5 14L1 9H9L5 14Z" fill="currentColor" className="dt-sort-down" />
  </svg>
);
