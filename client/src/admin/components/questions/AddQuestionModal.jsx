...
const AddQuestionModal = ({ close, programs }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      ...
      >
        ...
        <div className="flex justify-end gap-3 border-t border-slate-200 px-5 py-4">
          ...
          <button className="rounded-lg bg-sky-500 px-5 py-2 text-sm font-medium text-white shadow hover:bg-sky-600">
            Add Question
          </button>
