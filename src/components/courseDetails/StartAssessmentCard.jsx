import { ArrowRight, Clock3, Award, HelpCircle } from "lucide-react";
        ...
        <div className="overflow-hidden rounded-[32px] border border-cyan-400/20 bg-gradient-to-r from-cyan-500/10 via-[#111827] to-emerald-500/10 p-10 lg:p-14">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
              ...
              <button className="group mt-10 flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-cyan-400 to-emerald-400 px-8 py-4 font-semibold text-black transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-cyan-500/30">
